...
class CRusWords
{
    ...
    static function strWord($text, $counttext = 10, $sep = ' ')
    {
...
//	    array('', '', '', 0), // 10^ 0
	...
	$rub = $tmp[0] ? number_format($tmp[0], 0, '', '-') : $inn;
    ...
    static function initials($namelong)
    {
	return preg_replace('/(\w+) (\w)\w+ (\w)\w+/iu', '$1 $2. $3.', $namelong);
    }
}
